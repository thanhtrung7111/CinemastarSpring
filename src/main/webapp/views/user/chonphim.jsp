...
<body>
	...
	<main>
		...
		<form class="container mt-4" action="/user/chonphim" method="post">
			<div class="row g-4">
										...
										<div>
											<div class="row g-4">
												...
												<c:forEach items="${phims}" var="phimItem">
													<input name="maPhim" value="${phimItem.maPhim}" hidden
														id="${phimItem.maPhim}" type="radio" />
													<label for="${phimItem.maPhim}"
														class="col-6 col-md-4 col-xl-3 product-item checkphim"
