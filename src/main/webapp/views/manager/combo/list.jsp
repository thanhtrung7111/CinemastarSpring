	...
	<div>
		<div class="d-flex">
			...
			<div class="flex-fill">
				...
				<div class="py-2 px-3">
					<h5 class="text-dark fs-6 my-3">Trang chủ / Quản lý combo</h5>
					<div class="rounded-3 overflow-hidden shadow-sm bg-white px-4 py-3">
						<div class="d-flex justify-content-between">
							<h5 class="mb-3">Danh sách combo</h5>
							<div>
								<a href="./themmoicombo.html"
									...
									href="/admin/createcombo"> <i class="ri-file-add-line"></i>
									Thêm mới
								</a>
							</div>
						</div>
							...
							<tbody>
								<c:forEach items="${list}" var="item" varStatus="loop">
									<tr class="text-sm">
										...
										<td>${item.maCombo}</td>
										<td>${item.tenCombo}</td>
										<td><fmt:formatNumber value="${item.giaCombo}"
												pattern="#,###" /> VNĐ</td>
										...
										<td>
											<div class="d-flex column-gap-2">
												<a
													...
													href="/admin/deletecombo?id=${item.maCombo}"></a><a
													href="/admin/updatecombo?id=${item.maCombo}"
