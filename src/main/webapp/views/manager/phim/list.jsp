	...
	<div>
		<div class="d-flex">
			...
			<div class="flex-fill">
				...
				<div class="py-2 px-3">
					<h5 class="text-dark fs-6 my-3">Trang chủ / Quản lý phim</h5>
					<div class="rounded-3 overflow-hidden shadow-sm bg-white px-4 py-3">
						<div class="d-flex justify-content-between">
							<h5 class="mb-3">Danh sách phim</h5>
							<div>
								<a href="./themmoicombo.html"
									...
									href="/admin/createphim	"> <i class="ri-file-add-line"></i>
									Thêm mới
								</a>
							</div>
						</div>
										...
										<td>
											<div class="d-flex column-gap-2">
												<a
													...
													href="/admin/deletephim?id=${item.maPhim}"></a><a
													href="/admin/updatephim?id=${item.maPhim}"
