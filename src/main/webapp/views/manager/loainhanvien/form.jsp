	...
	<div>
		<div class="d-flex">
			...
			<div class="flex-fill">
				...
				<div class="py-2 px-3">
					<h5 class="text-dark fs-6 my-3">Trang chủ / Quản lý loại nhân
						viên / ${update ? 'Cập nhật' : 'Thêm mới'}</h5>
					<form:form modelAttribute="entity" method="post"
						action="${update ? '/admin/updateloainhanvien' : '/admin/createloainhanvien'}"
                  ...
                  >
                    <i class="ri-file-add-line"></i> Thêm mới
						...
						<div class="row g-3 mb-3">
							<div class="col-6">
								<form:input type="text" path="maLoaiNhanVien"
