	...
	<div>
		<div class="d-flex">
			...
			<div class="flex-fill">
				...
				<div class="py-2 px-3">
					<h5 class="text-dark fs-6 my-3">Trang chủ / Quản lý loại tài
						khoản</h5>
					<div class="rounded-3 overflow-hidden shadow-sm bg-white px-4 py-3">
						<div class="d-flex justify-content-between">
							<h5 class="mb-3">Danh sách loại tài khoản</h5>
							<div>
								<a href="./themmoicombo.html"
									...
									href="/admin/createloaitaikhoan"> <i
						...
						<table class="table">
							<thead>
								<tr>
									...
									<th scope="col">Chi tiêu tối thiêu</th>
							...
							<tbody>
								<c:forEach items="${list}" var="item" varStatus="loop">
									<tr class="text-sm">
										...
										<td>${loop.index+1}</td>
										<td>${item.maLoaiTaiKhoan}</td>
										<td>${item.tenLoaiTaiKhoan}</td>
										<td><fmt:formatNumber value="${item.chiTieuToiThieu}"
												pattern="#,###" /> VNĐ</td>
										<td>${item.mota}</td>
										<td>
											<div class="d-flex column-gap-2">
												<a
													...
													href="/admin/deleteloaitaikhoan?id=${item.maLoaiTaiKhoan}"></a><a
													href="/admin/updateloaitaikhoan?id=${item.maLoaiTaiKhoan}"
