			...
			<div class="flex-fill">
				...
				<div class="py-2 px-3">
					...
					<form:form modelAttribute="entity" method="post"
						action="${update ? '/admin/updateloaitaikhoan' : '/admin/createloaitaikhoan'}"
						cssClass="rounded-3 overflow-hidden shadow-sm bg-white px-4 py-3">
						<!-- <div class="d-flex justify-content-between"> -->
						<h5 class="mb-4">${update ? 'Cập nhật ' : 'Thêm mới '} loại tài khoản</h5>
						<!-- <div>
                  <button
                  ...
                  >
                    <i class="ri-file-add-line"></i> Thêm mới
						...
						<div class="row g-3 mb-3">
							<div class="col-6">
								<form:input type="text" path="maLoaiTaiKhoan"
							...
							<div class="col-6">
								<div>
									<label class="form-label text-sm text-dark fw-bolder mb-1">Chi tiêu tối thiểu</label>
									<form:input type="text" path="chiTieuToiThieu"
										cssClass="form-control form-control-sm"
										cssErrorClass="form-control form-control-sm border-danger"
										placeholder="Nhập chi tiêu tối thiểu!" />
									<form:errors path="chiTieuToiThieu" cssClass="text-danger"
										style="font-size:12px"></form:errors>
								</div>
							...
							<div class="col-6">
								<div>
									<label class="form-label text-sm text-dark fw-bolder mb-1">Mô tả</label>
