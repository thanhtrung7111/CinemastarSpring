			...
			<div class="flex-fill">
				...
				<div class="py-2 px-3">
					...
					<form:form modelAttribute="entity" method="post"
						...
						action="${update ? '/admin/updatekhuyenmai' : '/admin/createkhuyenmai'}"
						cssClass="rounded-3 overflow-hidden shadow-sm bg-white px-4 py-3">
						<!-- <div class="d-flex justify-content-between"> -->
						<h5 class="mb-4">${update ? 'Cập nhật ' : 'Thêm mới '}khuyến
							mãi</h5>
						<!-- <div>
                  <button
                  ...
                  >
                    <i class="ri-file-add-line"></i> Thêm mới
						...
						<div class="row g-3 mb-3">
							...
							<div class="col-8">
								<form:input type="text" path="maKhuyenMai"
									cssClass="form-control form-control-sm d-none" />
								<div>
									<label class="form-label text-sm text-dark fw-bolder mb-1">Tên
										khuyến mãi</label>
									<form:input type="text" path="tenKhuyenMai"
								...
								<div>
									<label class="form-label text-sm text-dark fw-bolder mb-1">Phần
										trăm giảm</label>
									<form:input type="number" path="phanTramGiam" min="0" max="100"
										cssClass="form-control form-control-sm"
										cssErrorClass="form-control form-control-sm border-danger" />
									<form:errors path="phanTramGiam" cssClass="text-danger"
										style="font-size:12px"></form:errors>
								</div>
								<div>
									<label class="form-label text-sm text-dark fw-bolder mb-1">Ngày
										áp dụng</label>
									<form:input type="date" path="ngayApDung"
										cssClass="form-control form-control-sm"
										cssErrorClass="form-control form-control-sm border-danger" />
									<form:errors path="ngayApDung" cssClass="text-danger"
										style="font-size:12px"></form:errors>
								</div>
