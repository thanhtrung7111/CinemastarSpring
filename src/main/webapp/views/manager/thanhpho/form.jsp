			...
			<div class="flex-fill">
				...
				<div class="py-2 px-3">
					...
					<form:form modelAttribute="entity" method="post"
						action="${update ? '/admin/updatethanhpho' : '/admin/createthanhpho'}"
						cssClass="rounded-3 overflow-hidden shadow-sm bg-white px-4 py-3">
						<!-- <div class="d-flex justify-content-between"> -->
						<h5 class="mb-4">${update ? 'Cập nhật ' : 'Thêm mới '}thành
							phố</h5>
						<!-- <div>
                  <button
